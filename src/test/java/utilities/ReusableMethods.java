...
public class ReusableMethods {
    ...
    public static void tumSayfaFotoCek(WebDriver driver){
        ...
        /*
        dosya adini dinamik hale getirmek icin time stamp  kullanalim buna zaman damgasi  demek adi  tum sayfasi
        olsun ama foto  cektigim zamana gore kaydecek buda ardi ardi farkli  dosyalri  bulmak
        kolay  olacaktir
         */
