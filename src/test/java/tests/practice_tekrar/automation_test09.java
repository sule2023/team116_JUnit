...
public class automation_test09 extends TestBase {
    ...
    public  void Test09(){
      ...
      //  Assert.assertTrue(homepage.isDisplayed());
        ...
        //5. Verify user is navigated to ALL PRODUCTS page successfully( Kullanıcının başarıyla
        // TÜM ÜRÜNLER sayfasına yönlendirildiğini doğrulayın.)

       WebElement ALLPRODUCTS = driver.findElement(By.className("features_items"));
       Assert.assertTrue(ALLPRODUCTS.isEnabled());
       bekle(2);
        //6. Enter product name in search input and click search button(Arama girişine ürün adını girin
        // ve arama düğmesine tıklayın.)
        WebElement searchInput = driver.findElement(By.xpath("//input[@name='search']"));
        searchInput.sendKeys("zonnebril");
